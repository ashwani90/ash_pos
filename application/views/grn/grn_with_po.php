  ...
  $.ajax({
    ...
    success: function(response){
	  ...
	  // var variant_id = response.variant_id;
	   ...
	   var content_13 = "<input type='hidden' class='variant_mrp[]' name='variant_mrp[]' value='"+variant_mrp+"'>";
	   ...
	   $(".item-row:first").before(content_1+content_2+content_3+content_4+content_5+content_6+content_7+content_8+content_9+content_10+content_11+content_12+content_13+content_14+content_15+content_16+content_17+content_18);
	   i++;
								...
								<div class="col-md-6">
									<div class="form-group"> 
									  <div class="col-md-12">
										...
										<input id="grn_date" name="grn_date" type="text" placeholder="Date" class="form-control input-md">
