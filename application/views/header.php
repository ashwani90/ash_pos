...
<body>
	<section class="header-bg">
		<div class="container-fluid">
			...
			<div class="col-md-1">
				<a href="<?php echo base_url();?>index.php/login/logout"><img src="<?php echo base_url();?>images/Graphicloads-100-Flat-2-People.ico" style="width:83px;height: 59px;margin-top: 20px;"></a>
			</div>
		</div>
		<div>
		</div>
